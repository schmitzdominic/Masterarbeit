...
%% Allgemeine Hinweise
% 
% - Windows benötigt Pearl zum Kompilieren
...
\usepackage{url}	% Urls
\usepackage{ae}		% Bessere Fonts unterstützung
\usepackage[latin1]{inputenc}	% Lateinisch und wichtig für MAC
...
\usepackage{minitoc}	% Mini Inhaltsverzeichnis nach jeder Überschrift
\usepackage[headsepline,footsepline]{scrpage2}	% Kopf und Fußzeilen (Seitenzahl)
\usepackage{listings}	% Quellcode
\usepackage{color}	% Farben fürs Listing
...
% 						Datei erstellt und sollten auch nur dort verändert werden.
%
%-----------------------------------------------------------------------------
\input{05_Settings/Settings}
...
% Danksagung
\input{01_Text/Danksagung}

% Kurzfassung
\input{01_Text/Kurzfassung}
...
%-----------------------------------------------------------------------------
\input{01_Text/Einleitung}
\input{01_Text/Grundlagen}
\input{01_Text/StandDerWissenschaft}
\input{01_Text/UnternehmensEinteilung}
\input{01_Text/Erfahrungen}
\input{01_Text/Analyse}
\input{01_Text/Herausforderungen}
\input{01_Text/Fazit}
